...
public class EsJson { 
	...
	public EsJson(ArrayList<String> appliances, Date created, String createdBy, String desc, long difficulty, boolean foodCooking, long idDb, String lang, String market, ArrayList<String> medias, Date modified, String modifiedBy, String name, ArrayList<String> packs, RatesJson rates, RecipesJson recipes, String resourceUri, String shortName, String sourceId, String sourceUri, String state, ArrayList<TagsJson> tags, ArrayList<String> terms, String tips, ArrayList<VariantsJson> variants, String version) { 
		super();
